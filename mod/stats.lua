...
alpha:addItem(CollectibleType.COLLECTIBLE_DEPRESSION) -- I want Sad Onion and give me the costume.
alpha:addItem(CollectibleType.COLLECTIBLE_PLAN_C)
alpha:addItem(CollectibleType.COLLECTIBLE_THUNDER_THIGHS, true)
alpha:addItem(CollectibleType.COLLECTIBLE_STRANGE_ATTRACTOR, true)
--[[
...
alpha:setPocketItem(Card.CARD_REVERSE_TEMPERANCE)
--[[
